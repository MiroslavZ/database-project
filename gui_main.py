...
class DocWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.add_doc_button.clicked.connect(self.goToEditOrAddDoctor)
    ...
    def goToEditOrAddDoctor(self):
        self.new_window = AddDoctorWindow(True)


class AddDoctorWindow(QWidget):
    isChief = False
    ...
    def init_ui(self):
        ...
        self.actual_surname = QLabel("NOTHING")
        self.actual_name = QLabel("NOTHING")
        self.actual_phone = QLabel("NOTHING")
        self.actual_email = QLabel("NOTHING")
        self.actual_password = QLabel("NOTHING")
        ...
        h_box_main.addLayout(v_box_right)
        self.setLayout(h_box_main)
        self.setWindowTitle("изменение личных данных/добавление нового доктора")
        self.show()
